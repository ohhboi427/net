...
namespace net {
    namespace {
        [[nodiscard]] constexpr auto convert_address_family(const AddressFamily address_family) noexcept -> i32 {
        ...
        [[nodiscard]] constexpr auto protocol_socket_properties(const Protocol protocol) -> std::tuple<i32, i32> {
            switch(protocol) {
            case Protocol::Tcp:
